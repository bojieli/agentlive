...
| M3: Complete adapters | Four adapters, family capture, remote/bundled artifacts, completeness notices, corpus evidence | Full common failure/fidelity matrix (interrupted tools, approvals, auth failures, source rotation) on real native versions; OpenCode live migration and compatible checkpoint rebuilding |
