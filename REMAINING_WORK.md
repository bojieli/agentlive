...
- Build revision/version-bound snapshot manifests and authorized snapshot/content endpoints. Seek by snapshot plus suffix, and prove equivalence to full replay.
